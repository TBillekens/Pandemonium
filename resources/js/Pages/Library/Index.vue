    ...
    <div>
        ...
        <article>
            ...
            <nav class="right-align">
                <a class="button small-round" href="/library/create">Create a new library</a>
            </nav>
        </article>
        <table v-if="libraries.length !== 0" class="stripes">
            <thead>
                <tr>
                    ...
                    <th class="center-align">Books</th>
            ...
            <tbody>
                <tr v-for="library in libraries" :key="library.id">
                    ...
                    <td class="center-align">{{ library.title }}</td>
                    <td class="center-align"></td>
                    <td>
                        <nav class="no-space center-align">
                            <a :href="'/library/' + library.id + '/edit'" class="button border small left-round">
                                <i>edit</i>
                            </a>
                            <button @click="deleteLibrary(library.id)" class="border small right-round fill">
                                <i>delete</i>
                            </button>
                        </nav>
                    </td>
